...
namespace CommonBoilerPlateEight.Infrastructure.Migrations
{
    ...
    [Migration("20240916162541_AddedCelebrityAndUserRelatedEntity")]
    partial class AddedCelebrityAndUserRelatedEntity
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Celebrity", b =>
                {
                    ...
                    b.HasIndex("CountryId", "MobileNumber")
                        .IsUnique()
                        .HasFilter("[CountryId] IS NOT NULL AND [MobileNumber] IS NOT NULL");
