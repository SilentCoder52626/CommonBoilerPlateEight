...
namespace CommonBoilerPlateEight.Infrastructure.Migrations
{
    ...
    [Migration("20241016150511_AddBookingRelatedEntities")]
    partial class AddBookingRelatedEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Advertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.BookingToAd", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Booking", b =>
                {
                    ...
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.Company", "Company")
                        .WithMany()
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.BookingToAd", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.Advertisement", "Advertisement")
                        .WithMany()
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
