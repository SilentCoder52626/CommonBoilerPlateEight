...
namespace CommonBoilerPlateEight.Infrastructure.Migrations
{
    ...
    partial class CommonBoilerPlateEightDbContextModelSnapshot : ModelSnapshot
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.AnswerOption", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("QuestionSettingId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Booking", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.BookingHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CartItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("CelebrityScheduleId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CelebrityScheduleId");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CartItemQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal?>("NumberAnswer")
                        .HasColumnType("decimal(18,3)");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CelebrityAdHistories");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CelebrityAdvertisements");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertismentQuestion", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CelebrityAdvertismentQuestions");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityLocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CelebrityLocations");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityReview", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("CelebrityReviews");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebritySchedule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CompanyType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.QuestionSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Wallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.AnswerOption", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.QuestionSetting", "QuestionSetting")
                        .WithMany("AnswerOptions")
                        .HasForeignKey("QuestionSettingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("QuestionSetting");
                });
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.BookingHistory", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.Booking", "Booking")
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CartItem", b =>
                {
                    ...
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CelebritySchedule", "CelebritySchedule")
                        .WithMany()
                        .HasForeignKey("CelebrityScheduleId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CompanyType", "CompanyType")
                        .WithMany()
                    ...
                    b.Navigation("CelebritySchedule");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CartItemQuestion", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CartItem", "CartItem")
                        .WithMany("CartItemQuestions")
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdHistory", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", "CelebrityAd")
                        .WithMany("CelebrityAdHistories")
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.Navigation("CelebrityAd");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.Booking", "Booking")
                        .WithMany("CelebrityAdvertisements")
                        .HasForeignKey("BookingId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertismentQuestion", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", "CelebrityAdvertisement")
                        .WithMany("CelebrityAdvertismentQuestions")
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                    ...
                    b.Navigation("CelebrityAdvertisement");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityReview", b =>
                {
                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", "CelebrityAdvertisement")
                        .WithMany("CelebrityReviews")
                        .HasForeignKey("AdId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("CommonBoilerPlateEight.Domain.Entity.ApplicationUser", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedById")
                        .OnDelete(DeleteBehavior.NoAction);
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Booking", b =>
                {
                    ...
                    b.Navigation("CelebrityAdvertisements");
                });

            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CartItem", b =>
                {
                    b.Navigation("CartItemQuestions");
                });
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.Celebrity", b =>
                {
                    ...
                    b.Navigation("CelebrityLocations");

                    b.Navigation("CelebritySchedules");
            ...
            modelBuilder.Entity("CommonBoilerPlateEight.Domain.Entity.CelebrityAdvertisement", b =>
                {
                    b.Navigation("CelebrityAdHistories");

                    b.Navigation("CelebrityAdvertismentQuestions");

                    b.Navigation("CelebrityReviews");
                });
